...
import java.util.List;
    ...
    public class ItemService {
        ...
        public void createDummyItems() {
            ...
            Item item1 = new Item("Eggs", Types.FOOD.getDisplayName(), 2.79);
            ...
            Item item24 = new Item("Pasta", Types.FOOD.getDisplayName(), 1.79);
            ...
            Item item25 = new Item("Rice", Types.FOOD.getDisplayName(), 2.49);
            item25.setItemDescription("A cereal grain that is a staple food for a large part of the world's human population.");
            itemList.add(item25);

            Item item26 = new Item("Juice", Types.FOOD.getDisplayName(), 3.99);
            ...
            Item item27 = new Item("Water", Types.FOOD.getDisplayName(), 0.99);
        ...
        public List<Item> getAllItemsFromDatabase() {
            ...
            try {
                ...
                while (resultSet.next()) {
                    ...
                    String itemType = String.valueOf(resultSet.getString("item_type"));
                ...
                try (ResultSet resultSet = preparedStatement.executeQuery()) {
                    if (resultSet.next()) {
                        item = new Item(
                                ...
                                String.valueOf(resultSet.getString("item_type")),
